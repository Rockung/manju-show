export const findAttrs = (attrArray, name, getValueOnly = true) => {
 ...
 */
export const getAttrs = function (str, start, options) {
 ...
 * @returns token
 */
export const addAttrs = function (attrs, token) {
...
// 增加获取 attr string 方法
export const getAttrsString = function (attrs, fn) {
 ...
 */
export const hasDelimiters = function (where, options) {
  if (!where) {
  ...
  return function (str) {
    ...
    if (!options || !options.leftDelimiter) return false;
 ...
 */
export const removeDelimiter = function (str, options) {
 ...
 */
export const getMatchingOpeningToken = function (tokens, i) {
